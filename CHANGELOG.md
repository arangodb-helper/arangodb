...
## [v0.19.27](https://github.com/arangodb-helper/arangodb/tree/0.19.27) (2026-08-19)
- Bump `github.com/moby/go-archive` to v0.3.3 for CVE fix (CVE-2026-17106)

## [v0.19.26](https://github.com/arangodb-helper/arangodb/tree/0.19.26) (2026-08-17)
...
## [v0.19.20](https://github.com/arangodb-helper/arangodb/tree/0.19.20) (2026-04-06)
- CircleCI release workflow publishes `arangodb/arangodb-starter` as multi-arch (`linux/amd64`, `linux/arm64`) using Docker buildx and binfmt; Makefile Docker targets now use `buildx build`.
...
## [v0.19.16](https://github.com/arangodb-helper/arangodb/tree/0.19.16) (2026-02-04)
