...
func DatabaseVersion(ctx context.Context, log zerolog.Logger, arangodPath string, runner service.Runner) (driver.Version, bool, error) {
	retries := 25
	var err error
	for i := 0; i < retries; i++ {
...
func databaseVersion(ctx context.Context, arangodPath string, runner service.Runner) (driver.Version, bool, error) {
